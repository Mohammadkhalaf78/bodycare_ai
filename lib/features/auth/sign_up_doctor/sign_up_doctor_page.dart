            ...
            body: SafeArea(
              child: Padding(
                ...
                child: SingleChildScrollView(
                  child: Form(
                    key: context.read<DoctorCubit>().formkay,
                    child: Column(
                      children: [
                            ...
                            children: [
                              ...
                              AppFormPhoneFiled(
                                validator: (value) => (value == null || value.nsn.isEmpty)
                                    ...
                                    : (!RegExp(r'^\d{10,15}$').hasMatch(value.nsn))
                              ...
                              AppTextFormFiled(
                                validator: (value){
                                  ...
                                  if(value != context.read<DoctorCubit>().doctorRegistraionPassword.text){
                              ...
                              context.read<DoctorCubit>().state is SignUpLoading
                                  ...
                                  : AppTextButton(
                                      ...
                                      onPressed: () {
                                        if(context.read<DoctorCubit>().formkay.currentState!.validate()){
